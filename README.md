# Shri Mallikarjun Mobile Shop — Website (Sindagi)

- **Live:** https://shreekantha3.github.io/sindagi-shri-mallikarjun-mobile-shop/
- **Repo:** `shreekantha3/sindagi-shri-mallikarjun-mobile-shop` (branch `main` = source, `gh-pages` = deployed bundle where applicable)
- **Stack:** static Vite + Tailwind CSS, no backend. `base: '/sindagi-shri-mallikarjun-mobile-shop/'` for GitHub Pages project-site hosting.
